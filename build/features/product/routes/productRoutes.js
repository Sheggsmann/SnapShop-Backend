...
class ProductRoutes {
    ...
    routes() {
        ...
        this.router.put('/product/media/:productId', auth_middleware_1.authMiddleware.protect, auth_middleware_1.authMiddleware.checkAuth, auth_middleware_1.authMiddleware.restrictTo(['StoreOwner', 'Admin']), update_product_1.updateProduct.productWithMedia);
