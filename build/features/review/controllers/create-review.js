...
class Create {
    review(req, res) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (existingReview) {
                throw new error_handler_1.BadRequestError('You already reviewed this product');
            }
            ...
            const review = {
                ...
                store: (_a = product.store) === null || _a === void 0 ? void 0 : _a._id,
                storeName: (_b = product.store) === null || _b === void 0 ? void 0 : _b.name,
                body,
                rating
            };
