...
class StoreService {
  ...
  public async getFeaturedStores(): Promise<IStoreDocument[]> {
    const featuredStores: IStoreDocument[] = await StoreModel.find({
      _id: {
        $in: [
          // '65a3d6d67c55de33417d3763',
          // '65a3ddec7c55de33417d3842',
          // '65a73f185c67ea4db46e6eb5'
  ...
  public async saveStoreSlug(storeId: string, slug: string, slugUrl: string): Promise<void> {
    await StoreModel.updateOne({ _id: storeId }, { $set: { slug, slugUrl } });
  }
